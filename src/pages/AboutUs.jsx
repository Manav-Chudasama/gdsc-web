                  ...
                  <div className="w-full justify-start items-center gap-8 space-y-5 grid-cols-1">
                    <div className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                      ...
                      <p className="text-gray-500 text-base font-normal leading-relaxed">
                        GDSCs are Google-endorsed university clubs that educate
                        Google tech and collaborate on projects through
                        workshops and networking. Skills and industry ties
                        improve.
                      </p>
                    </div>
                    <div className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
